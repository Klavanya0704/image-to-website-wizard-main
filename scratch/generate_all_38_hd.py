...
print(f"Total Products to generate and compile: {len(PRODUCTS)}")

# Generate HD 1024x1024 images
...
for idx, p in enumerate(PRODUCTS):
    ...
    print(f"[{idx+1}/{len(PRODUCTS)}] Generating 1024x1024 HD image for: '{title}' -> {fname}...")
...
print("\nAll 1024x1024 images generated successfully!")
