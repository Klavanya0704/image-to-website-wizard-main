...
# Define the verified products strictly grouped by their single exact category
CATALOG_DEF = [
    # ==================== 1. 3D PRINTING (categorySlug: "3d-printing") ====================
    {
        "id": "3dp-1",
...
# EXACT_PRODUCT_CATEGORY_MAP - Maps every slug to its SINGLE category slug
cat_map = {
    # 3D Printing
...
cat_map_code = "{\n" + "\n".join([f'  "{k}": "{v}",' for k, v in cat_map.items()]) + "\n}"
