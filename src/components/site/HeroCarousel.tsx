        ...
        <AnimatePresence initial={false} custom={direction} mode="popLayout">
          ...
          >
            ...
            <div className="relative z-20 w-full sm:w-[35%] lg:w-[34%] h-full flex flex-col justify-center px-6 sm:px-8 lg:px-10 py-6 sm:py-8 bg-[#020719] shrink-0">
              {/* Subtle Tech Dot Grid Pattern on the left */}
              <div
              ...
              <motion.div
                ...
                className={`relative inline-flex items-center gap-1.5 rounded-full px-2.5 py-0.5 sm:px-3 sm:py-1 text-[10px] sm:text-[11px] font-black uppercase tracking-wider shadow-sm border backdrop-blur-md w-fit ${currentSlide.badgeColor}`}
              >
              ...
              <motion.h1
                ...
                className="relative mt-2.5 sm:mt-3 text-[28px] xs:text-[32px] sm:text-3xl lg:text-[38px] xl:text-[42px] font-extrabold tracking-tight leading-[1.08] text-white drop-shadow-sm"
              >
              ...
              <motion.p
                ...
                className="relative mt-2 sm:mt-2.5 text-[12px] sm:text-[13px] lg:text-sm text-slate-300 leading-snug font-medium max-w-[340px]"
              >
              ...
              <motion.div
                ...
                className="relative mt-4 sm:mt-5 flex items-center gap-2 sm:gap-3 w-full sm:w-auto pointer-events-auto"
              >
                <Link
              ...
              {/* 5. Benefit Pills */}
              <div className="relative mt-3.5 sm:mt-5 flex flex-wrap items-center gap-1.5 sm:gap-2.5 text-[10px] sm:text-[11px] font-bold text-white/90">
