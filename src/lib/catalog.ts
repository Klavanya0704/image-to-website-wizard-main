...
export const EXACT_PRODUCT_CATEGORY_MAP: Record<string, string> = {
  ...
  "cnc-wooden-decorative-panel": "cnc-machining",
  "cnc-carved-furniture-panel": "cnc-machining",
  ...
  "cnc-machined-linear-shaft": "cnc-machining",
  "cnc-machined-prototype-component": "cnc-machining",
  "cnc-metal-spacer-bushing-set": "cnc-machining",
...
export const DEFAULT_CATALOG_PRODUCTS: Product[] = [
  ...
  {
    id: "cnc-1",
    name: "CNC Aluminum Mounting Bracket",
    slug: "cnc-aluminum-mounting-bracket",
    category: "CNC Machining",
    category_slug: "cnc-machining",
    categorySlug: "cnc-machining",
    image_key: "cnc-aluminum-mounting-bracket",
    price: 799,
    discount_price: 599,
  ...
  {
    id: "cnc-2",
    name: "Precision CNC Flanged Bushing",
    slug: "precision-cnc-flanged-bushing",
    category: "CNC Machining",
    category_slug: "cnc-machining",
    categorySlug: "cnc-machining",
    image_key: "precision-cnc-flanged-bushing",
    price: 449,
    discount_price: 349,
  ...
  {
    id: "cnc-4",
    name: "CNC Stainless Steel Coupling",
    slug: "cnc-stainless-steel-coupling",
    category: "CNC Machining",
    category_slug: "cnc-machining",
    categorySlug: "cnc-machining",
    image_key: "cnc-stainless-steel-coupling",
    price: 649,
    discount_price: 499,
  ...
  {
    id: "cnc-5",
    name: "CNC Aluminum Fixture Plate",
  ...
  {
    id: "cnc-6",
    name: "CNC Carved Wooden Wall Panel",
  ...
  {
    id: "cnc-7",
    name: "CNC Wooden Sign Board",
    slug: "cnc-wooden-sign-board",
    category: "CNC Machining",
    category_slug: "cnc-machining",
    categorySlug: "cnc-machining",
    image_key: "cnc-wooden-sign-board",
    price: 1499,
    discount_price: 1199,
    material: "Kiln-Dried Solid Oak Wood",
    dimensions: "450 × 200 × 28 mm",
    manufacturing_method: "V-Bit 60° 3D Prism Carving & Raised Lettering",
    rating: 4.9,
    review_count: 35,
    bestseller: false,
    stock: 30,
    short_description: "V-carved deep relief typography and filigree wooden tavern/business sign board in oak.",
    description:
      "Custom deep V-groove carved wooden signboard with hand-painted recessed lettering and raised beveled border in weather-sealed white oak.",
    specifications: {
      Wood: "Solid White Oak Slab",
      CarvingDepth: "Up to 8mm Deep V-Carve",
      Finish: "Marine-Grade Exterior Polyurethane",
    },
    sku: "CNC-WOD-007",
    subcategory: "Wooden Signs",
    active: true,
    featured: false,
    created_at: "2026-01-07T00:00:00Z",
  },
  ...
  {
    id: "cnc-9",
    name: "CNC Wooden Decorative Panel",
    slug: "cnc-wooden-decorative-panel",
    category: "CNC Machining",
    category_slug: "cnc-machining",
    categorySlug: "cnc-machining",
    image_key: "cnc-wooden-decorative-panel",
    price: 2199,
    discount_price: 1699,
    material: "Solid Mahogany Hardwood (18mm)",
    dimensions: "500 × 350 × 18 mm",
    manufacturing_method: "High-Speed CNC Fretwork Routing & Edge Profiling",
    rating: 4.8,
    review_count: 22,
    bestseller: false,
    stock: 18,
    short_description: "Large architectural CNC cut lattice trellis screen panel in solid mahogany.",
    description:
      "Openwork geometric trellis screen panel CNC routed with precision plunge endmills from genuine mahogany for partition walls, cabinet inserts, and lighting diffusers.",
    specifications: {
      Material: "Solid Genuine Mahogany",
      Pattern: "Contemporary Geometric Trellis",
      Border: "25mm Solid Outer Frame",
    },
    sku: "CNC-WOD-009",
    subcategory: "Decorative Panels",
    active: true,
  ...
  {
    id: "cnc-10",
    name: "CNC Carved Furniture Panel",
    slug: "cnc-carved-furniture-panel",
    category: "CNC Machining",
    category_slug: "cnc-machining",
    categorySlug: "cnc-machining",
    image_key: "cnc-carved-furniture-panel",
    price: 1899,
    discount_price: 1499,
    material: "Selected American Cherry Wood",
    dimensions: "450 × 300 × 22 mm",
    manufacturing_method: "5-Axis 3D Relief Sculpting & Chamfer Profiling",
    rating: 4.9,
    review_count: 19,
    bestseller: false,
    stock: 22,
    short_description: "CNC bas-relief carved floral baroque furniture cabinet door face in cherry wood.",
    description:
      "Classical baroque relief floral acanthus leaf carving engineered for custom cabinetry doors, bespoke furniture drawer fronts, and headboards.",
    specifications: {
      Wood: "American Cherry Hardwood",
      CarvingStyle: "Classical Acanthus Bas-Relief",
      Fit: "Standard Stile & Rail Cabinet Fit",
    },
    sku: "CNC-WOD-010",
    subcategory: "Furniture Components",
    active: true,
    featured: false,
    created_at: "2026-01-10T00:00:00Z",
  },
  ...
  {
    id: "cnc-13",
    name: "CNC Router Wooden Relief Art",
  ...
  {
    id: "cnc-14",
    name: "CNC Machined Linear Shaft",
    slug: "cnc-machined-linear-shaft",
    category: "CNC Machining",
    category_slug: "cnc-machining",
    categorySlug: "cnc-machining",
    image_key: "cnc-machined-linear-shaft",
    price: 599,
    discount_price: 449,
  ...
  {
    id: "cnc-15",
    name: "CNC Machined Prototype Component",
  ...
  {
    id: "cnc-16",
    name: "CNC Metal Spacer & Bushing Set",
    slug: "cnc-metal-spacer-bushing-set",
    category: "CNC Machining",
    category_slug: "cnc-machining",
    categorySlug: "cnc-machining",
    image_key: "cnc-metal-spacer-bushing-set",
    price: 399,
    discount_price: 299,
    material: "Precision Turned 6061 Aluminum & C360 Brass",
    dimensions: "10mm OD × 5.2mm ID (5mm, 10mm, 15mm, 20mm Lengths)",
    manufacturing_method: "CNC Swiss Lathe Precision Turning & Micro-Deburring",
    rating: 4.9,
    review_count: 62,
    bestseller: false,
    stock: 150,
    short_description: "Set of 8 precision turned aluminum and brass cylindrical standoff spacers.",
    description:
      "Assorted set of 8 CNC turned standoff spacers with chamfered inner/outer edges for M5 bolts. Ideal for robotics spacing, 3D printer gantry standoffs, and sensor mounting.",
    specifications: {
      Quantity: "8 Pieces (4 Aluminum + 4 Brass)",
      Compatibility: "M5 / M4 Metric Screws",
      Finish: "Smooth Tumble-Polished",
    },
    sku: "CNC-SPC-016",
    subcategory: "Hardware & Spacers",
    active: true,
    featured: false,
