...
export const DEFAULT_CATALOG_PRODUCTS: Product[] = [
  ...
  {
    id: "cnc-5",
    name: "CNC Wooden Key Holder",
    title: "CNC Wooden Key Holder",
    slug: "cnc-wooden-key-holder",
    category: "CNC Machining",
    category_slug: "cnc-machining",
    categorySlug: "cnc-machining",
    image: "/products/cnc-wooden-key-holder.jpg",
    image_key: "cnc-wooden-key-holder",
    price: 899,
    discount_price: 699,
    material: "Solid Natural Hardwood & CNC Turned Brass Pegs",
    dimensions: "320 × 120 × 30 mm",
    manufacturing_method: "CNC Pocket Routing & Brass Hardware Press-Fit",
    rating: 4.8,
    review_count: 29,
    bestseller: false,
    stock: 40,
    short_description: "Precision CNC milled wall key rack organizer with phone shelf and brass pegs.",
    description:
      "Modern wall key organizer featuring a top utility pocket shelf and 5 solid turned brass hooks, carved from a single slab of solid hardwood.",
    specifications: {
      Material: "Solid Ash Hardwood",
      Hooks: "5 × Turned Solid Brass Pegs",
      Mounting: "Concealed Wall Keyhole Anchors",
    },
    sku: "CNC-WOD-005",
  ...
  {
    id: "cnc-6",
    name: "CNC Wooden Relief Carving",
  ...
  },
  {
    ...
    category_slug: "cnc-machining",
    categorySlug: "cnc-machining",
    image: "/products/cnc-wooden-sign-board.jpg",
    ...
    bestseller: false,
    stock: 30,
    short_description: "V-carved deep relief typography and filigree wooden sign board in oak.",
    description:
  ...
  },
  {
    ...
    category_slug: "cnc-machining",
    categorySlug: "cnc-machining",
    image: "https://images.unsplash.com/photo-1631556097152-c39479bbf9f3?auto=format&fit=crop&w=600&q=80",
  ...
  {
    id: "cnc-14",
    name: "CNC Machined Pulley",
    title: "CNC Machined Pulley",
    slug: "cnc-machined-pulley",
    category: "CNC Machining",
    category_slug: "cnc-machining",
    categorySlug: "cnc-machining",
    image: "/products/cnc-machined-pulley.jpg",
    image_key: "cnc-machined-pulley",
    price: 749,
    discount_price: 549,
    material: "6061-T6 Billet Aluminum & Steel Flanges",
    dimensions: "35mm Outer Dia × 20mm Width (8mm Bore)",
    manufacturing_method: "CNC Lathe Turning & Gear Shaper Tooth Broaching",
    rating: 4.8,
    review_count: 26,
    bestseller: false,
    stock: 50,
    short_description: "Precision CNC turned aluminum GT2 timing belt pulley with dual set screws.",
    description:
      "Precision CNC machined timing pulley designed for high-torque synchronous belt drives in robotics, 3D printers, and CNC linear actuators.",
    specifications: {
      Profile: "GT2 2mm Pitch (20T / 36T / 60T Options)",
      Bore: "8mm Precision Reamed with M4 Grubscrews",
      Material: "6061-T6 Aluminum with Clear Anodize",
    },
    sku: "CNC-PLY-014",
  ...
  {
    id: "cnc-15",
    name: "CNC Machined Prototype Part",
