...
export const EXACT_PRODUCT_CATEGORY_MAP: Record<string, string> = {
  ...
  "cnc-aluminum-heat-sink": "cnc-machining",
  "cnc-stainless-steel-coupling": "cnc-machining",
  "cnc-machined-shaft": "cnc-machining",
  "cnc-metal-spacer-set": "cnc-machining",
  "cnc-precision-motor-mount": "cnc-machining",
  "cnc-machined-enclosure": "cnc-machining",
...
export const DEFAULT_CATALOG_PRODUCTS: Product[] = [
  ...
  {
    id: "cnc-4",
    name: "CNC Aluminum Heat Sink",
    slug: "cnc-aluminum-heat-sink",
    category: "CNC Machining",
    category_slug: "cnc-machining",
    categorySlug: "cnc-machining",
    image_key: "cnc-aluminum-heat-sink",
    price: 999,
    discount_price: 799,
    material: "High Thermal Conductivity 6063 Aluminum",
    dimensions: "100 × 80 × 30 mm",
    manufacturing_method: "CNC Slotted Fin Milling & Lapped Base",
    rating: 4.8,
    review_count: 29,
    bestseller: false,
    stock: 50,
    short_description: "Precision CNC milled black anodized aluminum heatsink with parallel cooling fins.",
    description:
      "Engineered thermal dissipation heat sink block with precision CNC milled cooling fins and mirror-lapped contact pad for power electronics and motor drivers.",
    specifications: {
      Material: "6063-T5 Aluminum",
      Finish: "Matte Black Thermal Anodizing",
      ThermalResistance: "1.2 °C/W",
    },
    sku: "CNC-HSK-004",
  ...
  },
  {
    ...
    price: 599,
    discount_price: 449,
    material: "Precision Induction-Hardened Steel (CF53)",
    dimensions: "12mm Diameter × 300mm Length",
    manufacturing_method: "CNC Turning, Step Grinding & Keyway Milling",
    rating: 4.8,
    review_count: 22,
    bestseller: false,
    stock: 40,
    ...
    description:
      "Precision machined drive shaft with ground steps for bearing seats, retaining ring grooves, and milled keyway for positive torque transfer.",
    specifications: {
      Tolerance: "h6 Ground Surface",
      Hardness: "HRC 60-64 Surface Layer",
      Straightness: "< 0.05mm / 300mm",
    },
    sku: "CNC-SHF-006",
  ...
  {
    id: "cnc-7",
    name: "CNC Metal Spacer Set",
    slug: "cnc-metal-spacer-set",
    category: "CNC Machining",
    category_slug: "cnc-machining",
    categorySlug: "cnc-machining",
    image_key: "cnc-metal-spacer-set",
    price: 349,
    discount_price: 249,
    material: "Machined 6061 Aluminum & Polished Brass",
    dimensions: "10mm OD × 5.2mm ID (5mm, 10mm, 15mm, 20mm Lengths)",
    manufacturing_method: "High-Precision CNC Lathe Turning & Deburring",
    rating: 4.9,
    review_count: 67,
    bestseller: false,
    stock: 150,
    ...
    description:
      "Assorted set of 8 CNC turned standoff spacers with chamfered inner/outer edges for M5 bolts. Ideal for robotics spacing and sensor mounting.",
    specifications: {
      Quantity: "8 Pieces (2 of each length)",
      Compatibility: "M5 / M4 Fasteners",
  ...
  {
    id: "cnc-8",
    name: "CNC Precision Motor Mount",
    slug: "cnc-precision-motor-mount",
    category: "CNC Machining",
    category_slug: "cnc-machining",
    categorySlug: "cnc-machining",
    image_key: "cnc-precision-motor-mount",
    price: 849,
    discount_price: 649,
    material: "Billet 6061-T6 Aluminum",
    dimensions: "65 × 65 × 16 mm (NEMA 17/23 Pattern)",
    manufacturing_method: "CNC Milling & Pocketing with Cooling Ports",
    rating: 5.0,
    review_count: 38,
    bestseller: true,
    stock: 55,
    short_description: "Billet aluminum stepper motor faceplate mount with adjustment slots.",
    description:
      "Sturdy CNC machined aluminum motor mounting plate with slotted tensioning bolt tracks and circular heat ventilation ports.",
    specifications: {
      MotorStandard: "NEMA 17 & NEMA 23 Dual Pattern",
      AdjustmentRange: "15mm Slotted Travel",
  ...
  {
    id: "cnc-9",
    name: "CNC Machined Enclosure",
    slug: "cnc-machined-enclosure",
    category: "CNC Machining",
    category_slug: "cnc-machining",
    categorySlug: "cnc-machining",
    image_key: "cnc-machined-enclosure",
    price: 2199,
    discount_price: 1699,
    material: "Solid Billet 6061 Aluminum Block",
    dimensions: "140 × 90 × 45 mm",
    manufacturing_method: "High-Speed CNC Cavity Milling & O-Ring Channel Grooving",
    rating: 4.8,
    review_count: 17,
    bestseller: false,
    stock: 20,
    short_description: "Solid billet CNC hollow milled electronics project enclosure with lid.",
    description:
      "Heavy-duty water-resistant CNC milled aluminum enclosure carved from a single solid aluminum block. Includes gasket seal channel and stainless screws.",
    specifications: {
      Material: "Solid Billet 6061 Aluminum",
      Sealing: "Perimeter O-Ring Channel (IP65 Rated)",
      WallThickness: "3.5mm Heavy Wall",
    },
    sku: "CNC-ENC-009",
    subcategory: "Enclosures & Chassis",
    active: true,
    featured: false,
    created_at: "2026-01-09T00:00:00Z",
  },
