...
export const EXACT_SLUG_IMAGE_MAP: Record<string, string> = {
  ...
  "custom-laser-engraved-wooden-keychain": "https://images.unsplash.com/photo-1607604276583-eef5d076aa5f?auto=format&fit=crop&w=800&q=80",
  "laser-cut-tree-of-life-wooden-led-lamp": "https://images.unsplash.com/photo-1513519245088-0e12902e5a38?auto=format&fit=crop&w=800&q=80",
  "slot-together-plywood-desktop-organizer": "https://images.unsplash.com/photo-1544816155-12df9643f363?auto=format&fit=crop&w=800&q=80",
  "multi-layered-wooden-mandala-wall-art": "https://images.unsplash.com/photo-1581092160607-ee22621dd758?auto=format&fit=crop&w=800&q=80",
  "laser-engraved-hardwood-photo-frame": "https://images.unsplash.com/photo-1583847268964-b28dc8f51f92?auto=format&fit=crop&w=800&q=80",
  "edge-lit-laser-cut-acrylic-led-sign": "https://images.unsplash.com/photo-1563089145-599997674d42?auto=format&fit=crop&w=800&q=80",
